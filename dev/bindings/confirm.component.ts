...
@Component({
    ...
    template: `
        ...
        <p>Your is is <span class="highlight">{{myself.name}}</span> and you're <span class="highlight">{{myself.age}}</span> years old. Please click on 'Conrirm' if you have made any changes to this information.</p>
        <div>
